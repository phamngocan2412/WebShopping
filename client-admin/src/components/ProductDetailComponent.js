        ...
        <form>
          <table >
            <tbody>
              ...
              <tr>
                <td className='sl'>Size</td>
                <td>
                <select value={this.state.cmbSize} onChange={(e) => { this.setState({ cmbSize: e.target.value }) }}>
              ...
              <tr>
              <td colSpan="2">
                <div style={{ width: '400px', height: '400px', border: '1px solid #ddd', borderRadius: '5px', overflow: 'hidden', boxShadow: '0px 0px 5px 0px rgba(0,0,0,0.5)' }}>
                  <img src={this.state.imgProduct} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="" />
                </div>
              </td>
              </tr>
            </tbody>
  ...
  btnAddClick(e) {
    ...
    if (name && price && size && category && image) {
      if (size === "Select") {
        ...
        const prod = { name: name, price: price, size: size ,category: category, image: image };
